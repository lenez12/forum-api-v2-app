...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.TITLE_HAVE_LIMIT_CHAR': new InvariantError('tidak dapat membuat thread baru karena title tidak boleh lebih dari 50 karakter'),
  ...
  'COMMENTED_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mengambil commented thread  karena properti yang dibutuhkan tidak ada'),
  'COMMENTED_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mengambil commented thread karena tipe data tidak sesuai'),
